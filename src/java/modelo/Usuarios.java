...
@NamedQueries({
    ...
    , @NamedQuery(name = "Usuarios.Buscar", query = "SELECT u FROM Usuarios u WHERE u.username = :usu and u.password = :pass")
    , @NamedQuery(name = "Usuarios.Buscarusername", query = "SELECT u FROM Usuarios u WHERE u.username = :usu")
    , @NamedQuery(name = "Usuarios.BuscarCliente", query = "SELECT u FROM Usuarios u WHERE u.idTipoUsu.id = 3")
    , @NamedQuery(name = "Usuarios.BuscarUsuario", query = "SELECT u FROM Usuarios u WHERE u.idTipoUsu.id= 1")
    , @NamedQuery(name = "Usuarios.findByActivos", query = "SELECT u FROM Usuarios u WHERE u.status = 1") 
    , @NamedQuery(name = "Usuarios.findByInactivos", query = "SELECT u FROM Usuarios u WHERE u.status = 0")
