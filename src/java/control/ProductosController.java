...
public class ProductosController implements Serializable {
    ...
    private List<Productos> items_baja = null;
    private Productos selected;

    public List<Productos> getItems_baja() {
        if (items_baja == null) {
    ...
    public void setItems_baja(List<Productos> items_baja) {
    ...
    public void create() {
        if (selected.getStock() <= selected.getExistencia()) {
            if (selected.getPrecioCompra() <= selected.getPrecioVenta()) {
                ...
                FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "El precio de Venta tiene que ser mayor al percio de compra", null));
            }
        } else {
            FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "El stock tiene que ser menor al de la existencia", null));
        }
